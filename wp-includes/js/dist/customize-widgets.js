...
function WelcomeGuide({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
      ...
      children: isEntirelyBlockWidgets ? (0,external_wp_i18n_namespaceObject.__)('Your theme provides different â€œblockâ€ areas for you to add and edit content.Â Try adding a search bar, social icons, or other types of blocks here and see how theyâ€™ll look on your site.') : (0,external_wp_i18n_namespaceObject.__)('You can now add any block to your siteâ€™s widget areas. Donâ€™t worry, all of your favorite widgets still work flawlessly.')
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
      size: "compact",
      variant: "primary",
  ...
  return class SidebarSection extends customize.Section {
    ready() {
      ...
      this.inspector = new InspectorSection(getInspectorSectionId(this.id), {
        ...
        parentSection: this,
        customizeAction: [(0,external_wp_i18n_namespaceObject.__)('Customizing'), (0,external_wp_i18n_namespaceObject.__)('Widgets'), this.params.title].join(' â–¸ ')
      });
